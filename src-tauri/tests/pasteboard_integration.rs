...
use objc2_app_kit::{
    NSApplication, NSPasteboard, NSPasteboardItem, NSPasteboardTypeFileURL, NSPasteboardTypePNG,
...
fn main() {
    let ran = autoreleasepool(|_| {
        ...
        let name = NSString::from_str(&format!("com.easyclipboard.tests.{}", uuid::Uuid::new_v4()));
